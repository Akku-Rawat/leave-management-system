  ...
  return (
    <div className="h-full overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50 to-white p-6">
      <div className="max-w-7xl mx-auto ">
        {/* PURE CARD */}
        <div
          className="bg-white rounded-3xl shadow-lg border border-gray-200 overflow-hidden flex"
          style={{ height: "600px" }}
        >
            ...
            <div className="lg:w-3/5 p-8 bg-gradient-to-br from-gray-50 to-white flex flex-col">
              ...
              >
                {requests.map((req) => (
                  <div
                    key={req.leave_id}
                    className={`bg-white p-6 rounded-xl shadow border border-gray-200 transition-all duration-400 ease-in-out ${
                      removingIds.includes(req.leave_id)
                        ? "opacity-0 max-h-0 overflow-hidden p-0 m-0"
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-gray-700">
                          {req.type} • {formatISODate(req.start_date)} → {formatISODate(req.end_date)}
                        </p>
