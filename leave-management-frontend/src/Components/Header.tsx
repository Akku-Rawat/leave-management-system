...
const DropdownPortal: React.FC<{
  ...
  useEffect(() => {
    if (anchorRef.current) {
      ...
      setPos({ top: rect.bottom + window.scrollY + 5, left: rect.left + window.scrollX, width: rect.width });
    }
  }, [anchorRef]);
...
const Header: React.FC<HeaderProps> = ({ currentUser, onLogout }) => {
  ...
  const notifications = [
    ...
    { id: 2, message: "New leave policy updated", time: "1 day ago" },
    { id: 3, message: "Reminder: Submit timesheet", time: "3 days ago" },
  ];

  const handleSettingsAction = (action: string) => {
    setShowSettings(false);
    switch(action) {
      case "addUser": alert("Opening Add User..."); break;
      case "users": alert("Opening User Management..."); break;
      case "policies": alert("Opening Leave Policies..."); break;
      case "analytics": alert("Opening System Analytics..."); break;
      case "delegation": alert("Opening Delegation Settings..."); break;
      case "config": alert("Opening System Configuration..."); break;
      default: break;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center h-16">
          ...
          <div className="flex items-center">
            <FaUserCircle size={28} color="#2563eb" className="mr-3" aria-label="ROLAFACE Logo" />
            <span className="text-2xl font-bold text-gray-900 select-none">ROLAFACE</span>
          </div>
              ...
              <DropdownPortal anchorRef={notifRef} onClose={() => setShowNotifications(false)}>
                ...
                <div className="max-h-60 overflow-y-auto bg-white">
                  {notifications.map((notif) => (
                    <div key={notif.id} className="p-2 border-b hover:bg-gray-50">
